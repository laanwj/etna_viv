...
uint32_t contextbuf[] = {
    ...
    0xdeaddead, /* PAD */
/* pipe3DIndex */    0x08010e03, /* LOAD_STATE (1) Base: 0x0380C Size: 1 Fixp: 0 */
    ...
    0xdeaddead, /* PAD */
    0x18000000, //0x08030180, /* LOAD_STATE (1) Base: 0x00600 Size: 3 Fixp: 0 */
    0xdeaddead, //0x0c003008, /*   FE.VERTEX_ELEMENT_CONFIG[0] := TYPE=FLOAT,ENDIAN=NO_SWAP,NONCONSECUTIVE=0,STREAM=0x0,NUM=3,NORMALIZE=OFF,START=0x0,END=0xc */
    0x18000000, //0x180c3008, /*   FE.VERTEX_ELEMENT_CONFIG[1] := TYPE=FLOAT,ENDIAN=NO_SWAP,NONCONSECUTIVE=0,STREAM=0x0,NUM=3,NORMALIZE=OFF,START=0xc,END=0x18 */
    0xdeaddead, //0x24183088, /*   FE.VERTEX_ELEMENT_CONFIG[2] := TYPE=FLOAT,ENDIAN=NO_SWAP,NONCONSECUTIVE=1,STREAM=0x0,NUM=3,NORMALIZE=OFF,START=0x18,END=0x24 */
    0x18000000, /* NOP (3) */
    0xdeaddead, /* PAD */
    0x18000000, /* NOP (3) */
    0xdeaddead, /* PAD */
    ...
    0x00000000, /*   FE.VERTEX_STREAM_BASE_ADDR := *0x7c24e6f0 */
    0x00000000, /*   FE.VERTEX_STREAM_CONTROL := VERTEX_STRIDE=0x24 */
    0xdeaddead, /* PAD */
    ...
    0x00000000, /*   PE.DEPTH_ADDR := *0x7e6a0000 */
    0x00000000, /*   PE.DEPTH_STRIDE := 0x380 */
    ...
    0x00000000, /*   PE.COLOR_ADDR := *0x7f2c8700 */
    0x00000000, /*   PE.COLOR_STRIDE := 0x700 */
    0xdeaddead, /* PAD */
    ...
    0x00000000, /*   RS.SOURCE_ADDR := *0x7f284000 */
    0x00000400, /*   RS.SOURCE_STRIDE := 0x400 */
    0x00000000, /*   RS.DEST_ADDR := *0x7a003200 */
...
/* pipe2DIndex */ 0x18000000, /* NOP (3) */
    ...
    0xdeaddead, /* PAD */
#endif
/* linkIndex */    0x40000000, /* LINK (8) */
    0x00000000, /*  */
/* inUseIndex */    0x00000000
};
