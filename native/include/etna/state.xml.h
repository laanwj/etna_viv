...
- /home/orion/projects/etna_viv/rnndb/state.xml ( 104039 bytes, from 2013-01-11 17:56:38)
...
#define VIVS_GL_MULTI_SAMPLE_CONFIG_UNK0__MASK			0x00000003
#define VIVS_GL_MULTI_SAMPLE_CONFIG_UNK0__SHIFT			0
#define VIVS_GL_MULTI_SAMPLE_CONFIG_UNK0(x)			((x) << 0)
#define VIVS_GL_MULTI_SAMPLE_CONFIG_UNK0_MASK			0x00000008
#define VIVS_GL_MULTI_SAMPLE_CONFIG_UNK4__MASK			0x000000f0
#define VIVS_GL_MULTI_SAMPLE_CONFIG_UNK4__SHIFT			4
#define VIVS_GL_MULTI_SAMPLE_CONFIG_UNK4(x)			((x) << 4)
#define VIVS_GL_MULTI_SAMPLE_CONFIG_UNK4_MASK			0x00000100
...
#define VIVS_GL_VS_VARYING_NUM_COMPONENTS			0x0000381c
#define VIVS_GL_VS_VARYING_NUM_COMPONENTS_VAR0__MASK		0x00000007
#define VIVS_GL_VS_VARYING_NUM_COMPONENTS_VAR0__SHIFT		0
#define VIVS_GL_VS_VARYING_NUM_COMPONENTS_VAR0(x)		((x) << 0)
#define VIVS_GL_VS_VARYING_NUM_COMPONENTS_VAR1__MASK		0x00000070
#define VIVS_GL_VS_VARYING_NUM_COMPONENTS_VAR1__SHIFT		4
#define VIVS_GL_VS_VARYING_NUM_COMPONENTS_VAR1(x)		((x) << 4)
#define VIVS_GL_VS_VARYING_NUM_COMPONENTS_VAR2__MASK		0x00000700
#define VIVS_GL_VS_VARYING_NUM_COMPONENTS_VAR2__SHIFT		8
#define VIVS_GL_VS_VARYING_NUM_COMPONENTS_VAR2(x)		((x) << 8)
#define VIVS_GL_VS_VARYING_NUM_COMPONENTS_VAR3__MASK		0x00007000
#define VIVS_GL_VS_VARYING_NUM_COMPONENTS_VAR3__SHIFT		12
#define VIVS_GL_VS_VARYING_NUM_COMPONENTS_VAR3(x)		((x) << 12)
#define VIVS_GL_VS_VARYING_NUM_COMPONENTS_VAR4__MASK		0x00070000
#define VIVS_GL_VS_VARYING_NUM_COMPONENTS_VAR4__SHIFT		16
#define VIVS_GL_VS_VARYING_NUM_COMPONENTS_VAR4(x)		((x) << 16)
#define VIVS_GL_VS_VARYING_NUM_COMPONENTS_VAR5__MASK		0x00700000
#define VIVS_GL_VS_VARYING_NUM_COMPONENTS_VAR5__SHIFT		20
#define VIVS_GL_VS_VARYING_NUM_COMPONENTS_VAR5(x)		((x) << 20)
#define VIVS_GL_VS_VARYING_NUM_COMPONENTS_VAR6__MASK		0x07000000
#define VIVS_GL_VS_VARYING_NUM_COMPONENTS_VAR6__SHIFT		24
#define VIVS_GL_VS_VARYING_NUM_COMPONENTS_VAR6(x)		((x) << 24)
#define VIVS_GL_VS_VARYING_NUM_COMPONENTS_VAR7__MASK		0x70000000
#define VIVS_GL_VS_VARYING_NUM_COMPONENTS_VAR7__SHIFT		28
#define VIVS_GL_VS_VARYING_NUM_COMPONENTS_VAR7(x)		((x) << 28)

#define VIVS_GL_PS_VARYING_NUM_COMPONENTS			0x00003820
#define VIVS_GL_PS_VARYING_NUM_COMPONENTS_VAR0__MASK		0x00000007
#define VIVS_GL_PS_VARYING_NUM_COMPONENTS_VAR0__SHIFT		0
#define VIVS_GL_PS_VARYING_NUM_COMPONENTS_VAR0(x)		((x) << 0)
#define VIVS_GL_PS_VARYING_NUM_COMPONENTS_VAR1__MASK		0x00000070
#define VIVS_GL_PS_VARYING_NUM_COMPONENTS_VAR1__SHIFT		4
#define VIVS_GL_PS_VARYING_NUM_COMPONENTS_VAR1(x)		((x) << 4)
#define VIVS_GL_PS_VARYING_NUM_COMPONENTS_VAR2__MASK		0x00000700
#define VIVS_GL_PS_VARYING_NUM_COMPONENTS_VAR2__SHIFT		8
#define VIVS_GL_PS_VARYING_NUM_COMPONENTS_VAR2(x)		((x) << 8)
#define VIVS_GL_PS_VARYING_NUM_COMPONENTS_VAR3__MASK		0x00007000
#define VIVS_GL_PS_VARYING_NUM_COMPONENTS_VAR3__SHIFT		12
#define VIVS_GL_PS_VARYING_NUM_COMPONENTS_VAR3(x)		((x) << 12)
#define VIVS_GL_PS_VARYING_NUM_COMPONENTS_VAR4__MASK		0x00070000
#define VIVS_GL_PS_VARYING_NUM_COMPONENTS_VAR4__SHIFT		16
#define VIVS_GL_PS_VARYING_NUM_COMPONENTS_VAR4(x)		((x) << 16)
#define VIVS_GL_PS_VARYING_NUM_COMPONENTS_VAR5__MASK		0x00700000
#define VIVS_GL_PS_VARYING_NUM_COMPONENTS_VAR5__SHIFT		20
#define VIVS_GL_PS_VARYING_NUM_COMPONENTS_VAR5(x)		((x) << 20)
#define VIVS_GL_PS_VARYING_NUM_COMPONENTS_VAR6__MASK		0x07000000
#define VIVS_GL_PS_VARYING_NUM_COMPONENTS_VAR6__SHIFT		24
#define VIVS_GL_PS_VARYING_NUM_COMPONENTS_VAR6(x)		((x) << 24)
#define VIVS_GL_PS_VARYING_NUM_COMPONENTS_VAR7__MASK		0x70000000
#define VIVS_GL_PS_VARYING_NUM_COMPONENTS_VAR7__SHIFT		28
#define VIVS_GL_PS_VARYING_NUM_COMPONENTS_VAR7(x)		((x) << 28)

#define VIVS_GL_PS_VARYING_COMPONENT_USE(i0)		       (0x00003828 + 0x4*(i0))
#define VIVS_GL_PS_VARYING_COMPONENT_USE__ESIZE			0x00000004
#define VIVS_GL_PS_VARYING_COMPONENT_USE__LEN			0x00000002
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP0__MASK		0x00000003
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP0__SHIFT		0
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP0(x)		((x) << 0)
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP1__MASK		0x0000000c
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP1__SHIFT		2
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP1(x)		((x) << 2)
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP2__MASK		0x00000030
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP2__SHIFT		4
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP2(x)		((x) << 4)
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP3__MASK		0x000000c0
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP3__SHIFT		6
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP3(x)		((x) << 6)
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP4__MASK		0x00000300
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP4__SHIFT		8
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP4(x)		((x) << 8)
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP5__MASK		0x00000c00
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP5__SHIFT		10
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP5(x)		((x) << 10)
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP6__MASK		0x00003000
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP6__SHIFT		12
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP6(x)		((x) << 12)
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP7__MASK		0x0000c000
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP7__SHIFT		14
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP7(x)		((x) << 14)
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP8__MASK		0x00030000
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP8__SHIFT		16
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP8(x)		((x) << 16)
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP9__MASK		0x000c0000
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP9__SHIFT		18
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP9(x)		((x) << 18)
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP10__MASK		0x00300000
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP10__SHIFT		20
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP10(x)		((x) << 20)
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP11__MASK		0x00c00000
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP11__SHIFT		22
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP11(x)		((x) << 22)
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP12__MASK		0x03000000
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP12__SHIFT		24
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP12(x)		((x) << 24)
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP13__MASK		0x0c000000
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP13__SHIFT		26
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP13(x)		((x) << 26)
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP14__MASK		0x30000000
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP14__SHIFT		28
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP14(x)		((x) << 28)
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP15__MASK		0xc0000000
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP15__SHIFT		30
#define VIVS_GL_PS_VARYING_COMPONENT_USE_COMP15(x)		((x) << 30)
...
#define VIVS_VS_INPUT_COUNT_COUNT2__MASK			0x00001f00
#define VIVS_VS_INPUT_COUNT_COUNT2__SHIFT			8
#define VIVS_VS_INPUT_COUNT_COUNT2(x)				((x) << 8)
...
#define VIVS_PA_CONFIG_UNK0					0x00000001
#define VIVS_PA_CONFIG_UNK1					0x00000002
...
#define VIVS_PA_CONFIG_UNK6					0x00000040
#define VIVS_PA_CONFIG_UNK7					0x00000080
...
#define VIVS_PA_CONFIG_UNK11					0x00000800
...
#define VIVS_PA_CONFIG_UNK15					0x00008000
...
#define VIVS_PS_INPUT_COUNT_COUNT2__MASK			0x00001f00
#define VIVS_PS_INPUT_COUNT_COUNT2__SHIFT			8
#define VIVS_PS_INPUT_COUNT_COUNT2(x)				((x) << 8)
...
#define VIVS_TE_SAMPLER_CONFIG_1(i0)			       (0x00002000 + 0x4*(i0))
...
#define VIVS_TE_SAMPLER_CONFIG_2(i0)			       (0x000021c0 + 0x4*(i0))
...
#define VIVS_NEW_TE						0x00000000

#define VIVS_NEW_TE_SAMPLER(i0)				       (0x00010000 + 0x4*(i0))
#define VIVS_NEW_TE_SAMPLER__ESIZE				0x00000004
#define VIVS_NEW_TE_SAMPLER__LEN				0x00000020

#define VIVS_NEW_TE_SAMPLER_CONFIG_1(i0)		       (0x00010000 + 0x4*(i0))

#define VIVS_NEW_TE_SAMPLER_SIZE(i0)			       (0x00010080 + 0x4*(i0))

#define VIVS_NEW_TE_SAMPLER_LOG_SIZE(i0)		       (0x00010100 + 0x4*(i0))

#define VIVS_NEW_TE_SAMPLER_LOD(i0)			       (0x00010180 + 0x4*(i0))

#define VIVS_NEW_TE_SAMPLER_UNK10200(i0)		       (0x00010200 + 0x4*(i0))

#define VIVS_NEW_TE_SAMPLER_UNK10280(i0)		       (0x00010280 + 0x4*(i0))

#define VIVS_NEW_TE_SAMPLER_UNK10300(i0)		       (0x00010300 + 0x4*(i0))

#define VIVS_NEW_TE_SAMPLER_CONFIG_2(i0)		       (0x00010380 + 0x4*(i0))

#define VIVS_NEW_TE_SAMPLER_UNK10400(i0)		       (0x00010400 + 0x4*(i0))

#define VIVS_NEW_TE_SAMPLER_UNK10480(i0)		       (0x00010480 + 0x4*(i0))

#define VIVS_NEW_TE_SAMPLER_ADDR(i0)			       (0x00010800 + 0x40*(i0))
#define VIVS_NEW_TE_SAMPLER_ADDR__ESIZE				0x00000040
#define VIVS_NEW_TE_SAMPLER_ADDR__LEN				0x00000020

#define VIVS_NEW_TE_SAMPLER_ADDR_LOD(i0, i1)		       (0x00010800 + 0x40*(i0) + 0x4*(i1))
#define VIVS_NEW_TE_SAMPLER_ADDR_LOD__ESIZE			0x00000004
#define VIVS_NEW_TE_SAMPLER_ADDR_LOD__LEN			0x0000000e

#define VIVS_NEW_TE_UNK12000(i0)			       (0x00012000 + 0x4*(i0))
#define VIVS_NEW_TE_UNK12000__ESIZE				0x00000004
#define VIVS_NEW_TE_UNK12000__LEN				0x00000100

#define VIVS_NEW_TE_UNK12400(i0)			       (0x00012400 + 0x4*(i0))
#define VIVS_NEW_TE_UNK12400__ESIZE				0x00000004
#define VIVS_NEW_TE_UNK12400__LEN				0x00000100
