...
static struct viv_profile_counter_info viv_profile_counters[] = {
    ...
    [VIV_PROF_GPU_TOTAL_READ_64_BYTES_PER_FRAME] = {"GPU_TOTAL_READ_64_BYTES_PER_FRAME", "GPU total read 64 bytes per frame"},
    [VIV_PROF_GPU_TOTAL_WRITE_64_BYTES_PER_FRAME] = {"GPU_TOTAL_WRITE_64_BYTES_PER_FRAME", "GPU total write 64 bytes per frame"},
...
int viv_read_profile_counters_3d(struct viv_conn *conn, uint32_t *out)
{
    ...
    out[VIV_PROF_GPU_TOTAL_READ_64_BYTES_PER_FRAME] = counters->gpuTotalRead64BytesPerFrame;
    out[VIV_PROF_GPU_TOTAL_WRITE_64_BYTES_PER_FRAME] = counters->gpuTotalWrite64BytesPerFrame;
